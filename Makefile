...
export CONSOLE_CONFIG_FILEPATH=$(CONSOLE_CONFIG_FILEPATH) \
CONSOLE_SCHEMA_REGISTRY_ADDR=$(CONSOLE_SCHEMA_REGISTRY_ADDR) \
CONSOLE_RPC_ADDR=$(CONSOLE_RPC_ADDR) \
CONSOLE_PORT=$(CONSOLE_PORT);
endef

# Envoy service
define ENVOY_ENVS
export ENVOY_ADMIN_PORT=$(ENVOY_ADMIN_PORT) \
