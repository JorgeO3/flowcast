...
// WithUpdateProcessConsumer sets the consumer in the UpdateProcessUC usecase
func WithUpdateProcessConsumer(consumer redpanda.Consumer) UpdateProcessUCOpts {
	return func(cp *UpdateProcessUC) {
