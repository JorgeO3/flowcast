...
func NewNotFound(err string, original error) TranscodeError {
...
func NewConflict(err string, original error) TranscodeError {
...
func NewInternal(err string, original error) TranscodeError {
...
func NewUnauthorized(err string, original error) TranscodeError {
...
func NewForbidden(err string, original error) TranscodeError {
...
func NewTimeout(err string, original error) TranscodeError {
...
func NewTooManyRequests(err string, original error) TranscodeError {
